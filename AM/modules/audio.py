...
@AM.on_message(filters.command(["pause"], prefixes=["/", "!"]))    
...
@AM.on_message(filters.command(["resume"], prefixes=["/", "!"]))    
...
@AM.on_message(filters.command(["end"], prefixes=["/", "!"]))    
...
@AM.on_message(filters.command(["volume","vol"], prefixes="/"))
